...
var countries = ["sucre glace","the","farine","viande hachee","fromage rape","feuilles de yufka","cumin moulu","piment doux","oignon","coriandre","sel","poivre","oufs ","pain","beurre","vignes","citron","Persil","riz","pignons de pin","bouillon de volaille","huile d'olive","pois chiche","pommes de terre","courgettes ","cannelle","sardines","ail","poivre rouge doux","poivre noir",'Huile pour friture',"moules","levure","orange","sucre","fleur d'oranger","tomates","menthe","semoule de ble","sucre vanille","margarine","smen","eau","amandes","Miel","arottes","navets","gingembre","raz-el-hanout","paleron de boeuf","citrouille"];
