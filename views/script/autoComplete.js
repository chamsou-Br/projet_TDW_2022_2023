...
var countries = ["sucre glace","thé","farine","viande hachée","fromage râpé","feuilles de yufka","cumin moulu","piment doux","oignon","coriandre","sel","poivre","œufs ","pain","beurre","vignes","citron","Persil","riz","pignons de pin","bouillon de volaille","huile d'olive","pois chiche","pommes de terre","courgettes ","cannelle","sardines","ail","poivre rouge doux","poivre noir",'Huile pour friture',"moules","levure","orange","sucre","fleur d’oranger","tomates","menthe","semoule de blé","sucre vanillé","margarine","smen","eau","amandes","Miel","arottes","navets","gingembre","raz-el-hanout","paleron de boeuf","citrouille"];
