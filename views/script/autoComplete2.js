function autocomplete(inp, arr) {
  ...
  let SubmitBtn = document.querySelector(".autocomplete-container .submit")
  SubmitBtn.addEventListener("click",(e)=> {
    e.preventDefault();
    //add child 
    let val =document.querySelector(".autocomplete-container #myInput").value
    ...
    document.querySelector(".autocomplete-container").reset()
  })
